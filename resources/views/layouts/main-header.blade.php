				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							{{-- <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/edu.jpg')}}" class="logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/edu.jpg')}}" class="dark-logo-1" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/edu.jpg')}}" class="logo-2" alt="logo"></a>
							<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/edu.jpg')}}" class="dark-logo-2" alt="logo"></a> --}}
						</div>
