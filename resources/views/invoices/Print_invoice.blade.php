                ...
                <div class="card card-invoice">
                    <div class="card-body">
                        <div class="invoice-header">
                            <h1 class="invoice-title">فاتورة المريض</h1>
                        ...
                        <div class="row mg-t-20">
                            ...
                            <div class="col-md">
                                ...
                                <p class="invoice-info-row"><span>اسم المريض</span>
                                    <span>{{$invoice->patient->patient_name }}</span></p>
                                <p class="invoice-info-row"><span>التاريخ </span>
                                    <span>{{$invoice->invoice_Date}}</span></p>
                                <p class="invoice-info-row"><span>المرض</span>
                                    <span>{{$invoice->disease->disease_name}}</span></p>
                            </div>
                        </div>
                        <div class="table-responsive mg-t-40">
                            <table class="table table-invoice border text-md-nowrap mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>1</td>
                                        <td class="tx-12">{{$invoice->Status}}</td>
                                        <td class="tx-center">{{ number_format($invoice->Discount, 2) }}</td>
                                        <td class="tx-right">{{$invoice->note}}</td>
                                        {{-- @php
